...
from .services import load_folder_context
from .utils import (
	extract_root,
	list_extracted_folders,
...
def index(request: HttpRequest) -> HttpResponse:
	"""Choose home page: list extracted folders with covers."""
	folders, root = list_extracted_folders()
...
def thumbnail(request: HttpRequest, folder: str, filename: str) -> HttpResponse:
	...
	# Try extract_root first, then fallback to wallpapers_root
	root = extract_root()
